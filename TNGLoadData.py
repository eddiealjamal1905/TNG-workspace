...
simulation = "TNG300-1" # TNG simulation of interest
filePath = f"/virgotng/universe/IllustrisTNG/TNG300-1/output" # sim file path 
                                                              # data files
...
haloFields = ['GroupFirstSub', 'GroupPos', 'GroupVel',
              'GroupMassType', 'Group_M_Crit200', 'Group_M_Crit500',
              'Group_R_Crit200', 'Group_R_Crit500']
subhaloFields = ['SubhaloGrNr', 'SubhaloMassType', 'SubhaloPos',
                'SubhaloSpin', 'SubhaloVel']
...
def loadHaloDF():
    ...
    # 0 and 4 are the particle type numbers for gas and star particles, 
    # respectively.
    ...
    haloKeys = ['M_200c', 'M_500c', 'R_200c', 'R_500c', 'M_gas',
                'M_star', 'pos_x', 'pos_y', 'pos_z',
                'vel_x', 'vel_y', 'vel_z', 'BCG ID']
    haloVals = [haloM200, haloM500, haloR200, haloR500, haloGasMass,
                haloStarMass, haloPosX, haloPosY, haloPosZ, haloVelX,
                haloVelY, haloVelZ, centGalaxyID]
    ...
    dfHalos[['M_500c', 'M_200c', 
             'M_gas', 'M_star']] = dfHalos[['M_500c', 'M_200c', 
                                            'M_gas', 'M_star']].apply(np.log10, 
                                                                      axis = 0)
...
def loadSubDF():
    ...
    # the simulation.
    subKeys = ['M_gas', 'M_star', 'pos_x', 'pos_y',
                                   'pos_z', 'Parent ID']
    subVals = [subGasMass, subStarMass, subPosX, subPosY, subPosZ, subParentID]
    ...
    # Use a log mass scale.
    dfSubs[['M_gas', 'M_star']] = dfSubs[['M_gas', 'M_star']].apply(np.log10, 
                                                                    axis = 1)
